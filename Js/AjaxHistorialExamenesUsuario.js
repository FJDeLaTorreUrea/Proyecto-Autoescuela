window.addEventListener("load",function(ev)
{
    ...
    function cargaPagina(pagina)
    {
        ...
        ajax.onreadystatechange=function()
        {
            if(ajax.readyState==4 && ajax.status==200)
            {
                ...
                for(let i=0;i<cantidad;i++)
                {
                    ...
                    let Texto2=document.createTextNode(obj.datos.examenes[i].Fecha);   
                    crearTd2.appendChild(Texto2);

                    let crearTd3=document.createElement("td");
                    let Texto3=document.createTextNode(obj.datos.examenes[i].Aprobado);   
                    crearTd3.appendChild(Texto3);

                    let crearTd4=document.createElement("td");
                    let Texto4=document.createTextNode(obj.datos.examenes[i].Aciertos);   
                    crearTd4.appendChild(Texto4);


                    
                    let crearTd5=document.createElement("td");
                    let Texto5=document.createTextNode("Revisar");
                    crearTd5.appendChild(Texto5);
                    crearTd5.style.cursor="pointer";
                    crearTd5.style.padding="2px";
        ...
        ajax.open("GET","../../../php/Examenes/HistorialExamenesUsuario.php?pagina="+pagina);
        ajax.send();
